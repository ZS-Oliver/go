package cn.idea.utils.web;

import cn.idea.utils.kits.CookieKit;
...
public class Captcha {
    ...
    public static String captchaName = "_captcha";
    ...
    public static boolean validate(HttpServletRequest request, HttpServletResponse response, String userInputCaptcha) {
        userInputCaptcha = userInputCaptcha.trim();
        if (Strings.isNullOrEmpty(userInputCaptcha)) {
            return false;
        }
