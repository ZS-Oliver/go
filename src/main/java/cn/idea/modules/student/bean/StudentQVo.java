...
public class StudentQVo extends ConflictingQVo {
    ...
    private Float ageLow;
    private Float ageHigh;
    ...
    public Float getAgeLow() {
        return ageLow;
    }

    public Float getAgeHigh() {
        return ageHigh;
    }
    ...
    public static class StudentQVoBuilder extends Builder<StudentQVo> {
        ...
        public StudentQVoBuilder ageRange(@Nullable Float ageLow, @Nullable Float ageHigh) {
            if (q.isConflicting) {
                return this;
            }
        ...
        public StudentQVoBuilder sex(@Nullable String sex) {
            if (!q.isConflicting) {
                q.sv.setSex(sex);
            }
            return this;
