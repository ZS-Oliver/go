...
public class SourceController {
    ...
    /**
     * @api {get} /source/states > 获取来源类别的含义
     * @apiGroup SourceController
     * @apiPermission 管理员|市场经理|员工
     * @apiDescription 该接口用于获取来源类型type和含义
     * @apiSuccess {Map} kv 来源type及含义
     * @apiSuccessExample {json} 成功样例
     * {0:"社区",1:"小学",2:"幼儿园",3:"网络",4:"转介绍",5:"市调",6:"直访"}
     */
    @GetMapping("/states")
